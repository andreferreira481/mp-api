<?php
    ...
    function dashboard_Pagamentos_concluidos_search() {
        ...
        $Status_Notification_Admin = "approved";
             ...
             $resultado = mysqli_query($conexao, $busca);
                 ...
                 $resposta_aprroved = array(
                    ...
                    "prepaid_card" => $prepaid_card,
                     ...
                     //$json = json_encode($resposta_aprroved);

                     return $resposta_aprroved;
                    // echo $json;
