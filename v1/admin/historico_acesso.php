...
$descricao_acesso = "ACESSO PAGINA HISTORICO ACESSO ADMIN";
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      include("function_historico_acesso_admin_search.php");
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Historico de Acesso Admin</h4>
                    ...
                    <table id="example" class="table table-striped display" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th>Hora</th>
                          <th>Id Login</th>
                          <th>Id Usuario Acesso</th>
                          <th>Id Externo Acesso</th>
                          <th>Id Externo Admin</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                        historico_acesso_admin_search();
                        ?>
                      </tbody>
                      <tfoot>
                        <tr>
